#This code as of 2016.09.02 is a copy of code for the conex and shows only how the 4-20mA circuits work.
#It will have to be significantly updated prior to use.
